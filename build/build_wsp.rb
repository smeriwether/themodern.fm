def jd_picks_2022
  [
     [
      { pick: "Dolphins -4 at Bears" },
      { pick: "Vikings -3 at Commanders" },
      { pick: "Packers -3.5 at Lions" },
      { eliminator_pick: "Bengals" }
    ],
    [
...
def stephen_picks_2022
  [
    [
      { pick: "Seahawks +2 at Cardinals" },
      { pick: "Bucs -2.5 at Rams" },
      { pick: "Falcons +3 at Chargers" },
