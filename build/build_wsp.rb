def jd_picks_2022
  [
    [
      { pick: "Jags -6.5 vs. Titans", winner: false },
      { pick: "Bengals -9.5 vs. Ravens" },
      { pick: "Eagles -14 vs. Giants" },
      { eliminator_pick: "Eagles" }
    ],
    [
      { pick: "Raiders +9 vs. 49ers", winner: true },
      { pick: "Broncos +12.5 at Chiefs", winner: true },
      { pick: "Jets -2 at Seahawks", winner: false },
      { eliminator_pick: "49ers", winner: true }
    ],
    [
      { pick: "Falcons +7.5 at Ravens", winner: false },
      { pick: "Jags +2.5 at Jets", winner: true },
      { pick: "Browns -3 vs. Saints", winner: false },
      { eliminator_pick: "Bills", winner: true }
    ],
    [
    ...
    [
      ...
      { pick: "Bills -10 vs. Jets", winner: false },
      { pick: "Seahawks -4 vs. Panthers", winner: false },
      { eliminator_pick: "Chiefs", winner: true }
    ],
    [
      { pick: "Titans +4.5 at Eagles", winner: false },
      { pick: "Dolphins +4.5 at 49ers", winner: false },
      { pick: "Seahawks -7 at Rams", winner: false },
      { eliminator_pick: "Browns", winner: true }
    ],
    [
      { pick: "Dolphins -14 vs. Texans", winner: true },
      { pick: "Panthers +1 vs. Broncos", winner: true },
      { pick: "Jags +1.5 vs. Ravens", winner: true },
      { eliminator_pick: "Commanders", winner: true }
    ],
    [
      { pick: "Jets +3.5 at Patriots", winner: false },
      { pick: "Raiders +3 at Broncos", winner: true },
      { pick: "Panthers +13 at Ravens", winner: true },
      { eliminator_pick: "Ravens", winner: true }
    ],
    [
      { pick: "Chiefs -9 vs. Jags", winner: true },
      { pick: "Titans -3 vs. Broncos", winner: true },
      { pick: "Steelers +1.5 vs. Saints", winner: true },
...
def stephen_picks_2022
  [
    [
      { pick: "Vikings -7 at Bears" },
      { pick: "Rams +6 at Seahawks" },
      { pick: "Dolphins -3 vs. Jets" },
      { eliminator_pick: "Eagles" }
    ],
    [
      { pick: "Dolphins +2.5 at Patriots", winner: true },
      { pick: "49ers -9 at Raiders", winner: false },
      { pick: "Vikings +3.5 at Packers", winner: false },
      { eliminator_pick: "49ers", winner: true }
    ],
    [
      { pick: "Falcons +7.5 at Ravens", winner: false },
      { pick: "Eagles +5.5 at Cowboys", winner: false },
      { pick: "Chargers -4.5 at Colts", winner: true },
      { eliminator_pick: "Chargers", winner: true }
    ],
    [
    ...
    [
      ...
      { pick: "Jets +10 at Bills", winner: true },
      { pick: "49ers -3.5 vs. Bucs", winner: true },
      { eliminator_pick: "Chiefs", winner: true }
    ],
    [
      { pick: "Chargers +1 at Raiders", winner: false },
      { pick: "Chiefs -1.5 at Bengals", winner: false },
      { pick: "Vikings -3 vs. Jets", winner: true },
      { eliminator_pick: "Vikings", winner: true }
    ],
    [
      { pick: "Bucs -3 at Browns", winner: false },
      { pick: "Seahawks -3.5 vs. Raiders", winner: false },
      { pick: "Titans +2.5 vs. Bengals", winner: false },
      { eliminator_pick: "Seahawks", winner: false }
    ],
    [
      { pick: "Raiders +3 at Broncos", winner: true },
      { pick: "Giants -3 vs. Lions", winner: false },
      { pick: "Bears +3 at Falcons", "push": true },
      { eliminator_pick: "Giants", winner: false }
    ],
    [
      { pick: "Raiders -4.5 vs. Colts", winner: false },
      { pick: "Vikings +3.5 at Bills", winner: true },
      { pick: "Giants -4.5 vs. Texans", winner: true },
      { eliminator_pick: "Cowboys", winner: false }
    ],
    [
